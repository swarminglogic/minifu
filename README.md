...
USAGE
    minifu.sh  [--css|--js] -k KEY -p PREFIX -d OUT_DIR FILE_1 [..FILE_N]
    minifu.sh  [--css|--js] -k KEY -p PREFIX -d OUT_DIR FILE_1 [..FILE_N] [-s SRC_DIR]
...
EXAMPLE
    minifu.sh --css -k styles -p /css -d web/css src/css/*.css -s web
